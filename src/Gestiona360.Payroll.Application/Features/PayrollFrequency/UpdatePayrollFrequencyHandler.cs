// src/Gestiona360.Payroll.Application/Features/PayrollFrequencies/Commands/UpdatePayrollFrequencyHandler.cs
...
namespace Gestiona360.Payroll.Application.Features.PayrollFrequencies.Handlers;
...
public class UpdatePayrollFrequencyHandler : IRequestHandler<UpdatePayrollFrequencyCommand, PayrollFrequencyDto>
{
    ...
    public UpdatePayrollFrequencyHandler(
        IPayrollFrequencyRepository repository,
    ...
    public async Task<PayrollFrequencyDto> Handle(
        UpdatePayrollFrequencyCommand request,
        CancellationToken cancellationToken)
    {
        ...
        // Solo SaveChanges, el Behavior hace el Commit automáticamente
